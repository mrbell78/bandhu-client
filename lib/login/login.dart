                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text("Login With Email OR Phone Number",style: TextStyle(color: AppColors.banOrange,fontSize: 16,fontWeight: FontWeight.w600),),
                          ...
                          Container(
                            ...
                            child:  TextField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  hintText: 'email',
                                  contentPadding: EdgeInsets.only(bottom: 11,left: 10)
                              ),
                            ),
                            ...
                            Expanded(
                              child: GestureDetector(
                                onTap:(){
                                  ...
                                  provider.postLogin(emailController.text.trim(),passWordController.text.trim(),).then((value) {
