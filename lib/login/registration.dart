                            ...
                            Expanded(
                              child: InkWell(
                                onTap:(){
                                  ...
                                  provider.postRegistration(nameController.text.trim(),emailController.text.trim(),passwordController.text.trim()).then((value) {
                                   Navigator.pop(context);
                                   EasyLoading.showInfo("Registration successful");
